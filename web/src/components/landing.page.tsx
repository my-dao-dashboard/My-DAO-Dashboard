...
function LoginLink(props: React.PropsWithChildren<{ className?: string }>) {
  ...
  return (
    <a className={props.className} onClick={login}>
      Enter My DAO Dashboard
    </a>
  );
}
  ...
  return (
    <div className="landingpage">
      <div className="intro">
        <div className="intro_txt">
          <div className="intro_txt_logo">
            ...
            <p>
              In the fast-paced world of decentralized autonomous organizations, we need a single app to keep up to
              speed and tune in to all activity surrounding these instruments of decentralisation.
            </p>
            <LoginLink className="redlink">Enter My DAO Dashboard</LoginLink>
          </div>
        </div>
      ...
      <div className="usps_and_btn">
        <div className="usps">
          <div className="usp">
            ...
            <div className="usp_txt">
              ...
              <p>
                Apart from the DAO’s your participating in, you can also easily add some to your watchlist and observe
                their activity.
              </p>
            </div>
          </div>
          <div className="usp">
            ...
            <div className="usp_txt">
              <h2>Vote in-app.</h2>
              <p>
                See all active and passive proposals for each DAO, and execute the DAO’s most prominent feature, voting,
                directly in the app.{" "}
              </p>
            </div>
          </div>
          <div className="usp">
            ...
            <div className="usp_txt">
              ...
              <p>
                All key-metrics of your all of your DAO’s will be visible in the app, making sure you know what’s going
                on in each DAO.
              </p>
            </div>
          </div>
        ...
        <button>
          <LoginLink>Enter My Dao Dashboard</LoginLink>
        </button>
      </div>
      ...
      <div className="components">
        <div className="component left">
          <h2>Dao Scan</h2>
          <p>
            Data availability for DeFi is low, despite data being open. We index the whole Ethereum blockchain to
            provide the most fresh structured information about DAOs in real time: organisations, participants, votes*,
            assets under management*, everything important. It powers MyDAODashboard, and it could also serve your
            product.
          </p>
        ...
        <div className="component right">
          ...
          <p>
            MyDAODashboard provides a light-weight interface, a single point of interaction between a user and all the
            DAOs he wants to interact with. A user is able to view all key-metrics for each DAO, as well as vote on
            active proposals. The app also has the possibility for a user to follow DAOs of which he is not an active
            member.
          </p>
      ...
      <div className="supportedDAOs_and_txt">
        <p>
          These DAO-protocols will be supported in the app. Are we missing an important one?{" "}
          <a href="https://github.com/my-dao-dashboard/My-DAO-Dashboard/issues">Let us know!</a>
        </p>
      ...
      <div className="footer">
        <div className="footer_and_txt">
          ...
          <p>
            Originated at EthBerlinZwei, My DAO Dashboard is an open source community, aiming to contribute value to the
            decentralized world by creating useful tools for managing DAO’s.
          </p>
